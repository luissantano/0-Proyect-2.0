...
import com.iesemilidarder.dao.Opinio;
import com.iesemilidarder.dao.Restaurants;
//import com.learningjava.jpa.spring.dao.Restaurants;
...
public class ReadDB2 {
    ...
    public List<Restaurants> readRestaurants(String search) {
        ...
        try {
            ...
            ResultSetMapper<Restaurants> a = new ResultSetMapper<>();
            Function<ResultSet, Object> func = new Function<ResultSet, Object>() {
                public Object apply(ResultSet rs) {
                    return a.mapResultSetToObject(rs, Restaurants.class);
                }
            };
    ...
    public static Restaurants readRestaurantInfo(String id) {
    ...
    public List readRestaurantAPI() {
        ...
        try {
            ...
            arrayRestaurants= mapper.mapResultSetToObject(rs,Restaurants.class);
            stmt.close();con.close();
            //VERSION FUNCTIONAL
            arrayRestaurants = new ArrayList<>();
            Function<ResultSet, Object> func = new Function<ResultSet, Object>() {
                public Object apply(ResultSet rs) {
                    return mapper.mapResultSetToObject(rs, Restaurants.class);
                }
            };
            arrayRestaurants = (ArrayList) executequery(query, func);
